...
class Role(models.Model):
    ...
    role_name = models.CharField(max_length=50, choices=ROLE_CHOICES, unique=True)  # mandatory & constrained
...
class AccountMember(models.Model):
    ...
    class Meta:
        unique_together = ('account', 'user')  # prevents duplicate member entries
